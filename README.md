...
[`AppConfig` interface](https://github.com/clebert/aws-simple/blob/master/src/types.ts#L84).
...
different
[`StackConfig` objects](https://github.com/clebert/aws-simple/blob/master/src/types.ts#L76)
